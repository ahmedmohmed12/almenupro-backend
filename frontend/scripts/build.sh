...
echo "Almenupro frontend build v1.14.2 (checkout focus navigation)"
...
flutter build web \
  ...
  --dart-define=BUILD_FEATURE=checkout-focus-v1.14.2
...
BUILD_ID="1.14.2-checkout-focus-$(date -u +%Y%m%d%H%M%S)"
printf '{"build":"%s","features":["checkout-focus","mobile-menu","bilingual"]}\n' "$BUILD_ID" \
