...
echo "Almenupro frontend build v1.20.0 (smart upsell phase 2)"
...
flutter build web \
  ...
  --dart-define=BUILD_FEATURE=smart-upsell-phase2-v1.20.0
...
BUILD_ID="1.20.0-smart-upsell-phase2-$(date -u +%Y%m%d%H%M%S)"
printf '{"build":"%s","features":["smart-upsell-phase2","smart-recommendations-engine","advanced-linked-sides","checkout-impulse-bumps-v2","smart-upsell-sidebar","smart-upsell-phase1","menu-addons-side-items","profile-logout-dropdown","menu-edit-reorder","collapsible-sidebar","admin-pos-top","picks-for-you","brand-logo"]}\n' "$BUILD_ID" \
