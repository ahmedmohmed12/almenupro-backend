...
echo "Almenupro frontend build v1.19.0 (smart upsell phase 1)"
...
flutter build web \
  ...
  --dart-define=BUILD_FEATURE=smart-upsell-v1.19.0
...
BUILD_ID="1.19.0-smart-upsell-$(date -u +%Y%m%d%H%M%S)"
printf '{"build":"%s","features":["smart-upsell-phase1","menu-addons-side-items","profile-logout-dropdown","menu-edit-reorder","collapsible-sidebar","admin-pos-top","picks-for-you","brand-logo"]}\n' "$BUILD_ID" \
