...
echo "Almenupro frontend build v1.17.5 (profile logout dropdown)"
...
flutter build web \
  ...
  --dart-define=BUILD_FEATURE=profile-logout-v1.17.5
...
BUILD_ID="1.17.5-profile-logout-$(date -u +%Y%m%d%H%M%S)"
printf '{"build":"%s","features":["profile-logout-dropdown","menu-edit-reorder","collapsible-sidebar","admin-pos-top","picks-for-you","brand-logo"]}\n' "$BUILD_ID" \
