...
echo "Almenupro frontend build v1.13.3 (auto-translate menu items)"
...
flutter build web \
  ...
  --dart-define=BUILD_FEATURE=auto-translate-v1.13.3
...
BUILD_ID="1.13.3-auto-translate-$(date -u +%Y%m%d%H%M%S)"
printf '{"build":"%s","features":["auto-translate","restaurant-whatsapp","bilingual-migration","bilingual","delivery-zones"]}\n' "$BUILD_ID" \
