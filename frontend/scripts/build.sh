...
echo "Almenupro frontend build v1.14.1 (mobile viewport fix)"
...
flutter build web \
  ...
  --dart-define=BUILD_FEATURE=mobile-viewport-v1.14.1
...
BUILD_ID="1.14.1-mobile-viewport-$(date -u +%Y%m%d%H%M%S)"
printf '{"build":"%s","features":["mobile-menu","mobile-viewport","bilingual"]}\n' "$BUILD_ID" \
