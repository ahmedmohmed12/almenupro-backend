...
echo "Almenupro frontend build v1.12.0 (delivery zones admin)"
...
flutter build web \
  ...
  --dart-define=BUILD_FEATURE=delivery-zones-v1.12.0
...
BUILD_ID="1.12.0-delivery-zones-$(date -u +%Y%m%d%H%M%S)"
