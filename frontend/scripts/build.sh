...
echo "Almenupro frontend build v1.14.3 (checkout submit fix)"
...
flutter build web \
  ...
  --dart-define=BUILD_FEATURE=checkout-submit-v1.14.3
...
BUILD_ID="1.14.3-checkout-submit-$(date -u +%Y%m%d%H%M%S)"
printf '{"build":"%s","features":["checkout-submit","checkout-focus","mobile-menu"]}\n' "$BUILD_ID" \
