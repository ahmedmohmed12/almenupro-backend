...
echo "Almenupro frontend build v1.18.0 (menu add-ons & side items)"
...
flutter build web \
  ...
  --dart-define=BUILD_FEATURE=menu-addons-v1.18.0
...
BUILD_ID="1.18.0-menu-addons-$(date -u +%Y%m%d%H%M%S)"
printf '{"build":"%s","features":["menu-addons-side-items","profile-logout-dropdown","menu-edit-reorder","collapsible-sidebar","admin-pos-top","picks-for-you","brand-logo"]}\n' "$BUILD_ID" \
